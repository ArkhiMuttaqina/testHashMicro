                    ...
                    <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input <?php echo e($state == 'true' ? '' : ''); ?> class="form-control" id="nama_pengajuan" type="text"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input <?php echo e($state == 'true' ? '' : ''); ?> class="form-control" id="nominal" type="number" placeholder="Nominal"
                            ...
                            <div class="mb-3">
                                ...
                                <input <?php echo e($state == 'true' ? '' : ''); ?> class="form-control" id="desc" type="text" placeholder="Deskripsi Pengajuan"
                                    value="<?php echo e($state == 'true' ? $reimbursements->desc : ''); ?>" />
                            </div>
<?php if($reimbursements->files != null): ?>
                            <div class="mb-3">
                                <label class="small mb-1">Lihat File Lama <a href="<?php echo e(route('reimbursements_downloadFile', $reimbursements->id)); ?>">Link file</a></label>
                            </div>
                            <?php endif; ?>
                            <div class="mb-3">
...
<script type="text/javascript">
  ...
  function submit() {
            ...
            create.append('id', <?php echo e($reimbursements->id); ?>);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\Reimbursement SYSTEM\resources\views/reimbursements/edit.blade.php ENDPATH**/ ?>